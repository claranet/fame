...
def run():
    ...
    extra_dimensions = {
        ...
        "fame_function_app_resource_group": os.environ.get("WEBSITE_RESOURCE_GROUP", "unknown"),
        "fame_function_app_subscription_id": os.environ.get("WEBSITE_OWNER_NAME", "unknown").split("+")[0],
    }
